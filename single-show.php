						...
						<div class="episode-content">
                            ...
                            <div class="share">
                                ...
                                <div class="buttons">
                                    ...
                                    <a href="https://twitter.com/intent/tweet?url=<?php the_permalink(); ?>&text=<?php the_title(); ?>&via=KZRnet" target="_blank">
                                    ...
                                    <a href="whatsapp://send?text=<?php the_title(); ?> [at] KZRadio - <?php the_permalink(); ?>" target="_blank">
